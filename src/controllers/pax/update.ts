...
export class PaxUpdateController{
    handle = async(req: Request, res: Response) : Promise<Response> => {
        ...
        const { name, surname, email, occupation, address, birthday, imageURL } = req.body;
        ...
        const result = await service.execute({ name, surname, email, occupation, address, birthday, imageURL, user_id, event_id }, pax_id);
